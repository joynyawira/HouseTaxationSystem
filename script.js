...
function isCompliant(tax) {
    ...
    return totalTaxPaid > 250 && currentYearTax > 50;
}
...
function generateCertificate(name, id, house, tax) {
    ...
    let certificate = `<h2>Certificate of Taxation</h2>
                        ...
                        <p><span>Tax paid in the last 5 years:</span> $${lastFiveYearsTax}</p>
                        <p><span>Tax paid in the current year:</span> $${currentYearTax}</p>`;
